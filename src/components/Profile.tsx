...
const VerificationForm = () => {
  ...
  const { data: verificationForm, isLoading: verificationFormLoading } =
    useFetch<GetRolesType[]>(`api/Crew/GetRoles?code=OBE`);
      ...
      >
          ...
          <DisclaimerWindowWrapper style={styles.attention}>
            ...
            <View>
              <Text style={styles.attentionContent}>
                Your profile is not active until all data in the table has been
        ...
        >
          ...
          <View style={{ gap: 16, alignItems: "center" }}>
            <Text style={{ fontSize: 24, fontFamily: "Inter_500" }}>
              {`${firstName} ${lastName}`}
            </Text>
            <Text
              style={{
        ...
        >
          {/* <View style={{ flex: 1, marginTop: 16, gap: 16 }}>
            <View>
              <Text style={styles.tableTitle}>Point Configuration Details</Text>
            </View>
                            ...
                            <DisclaimerWindowWrapper>
                              <View style={styles.disclaimerContainer}>
                                ...
                                <Text style={styles.disclaimerContent}>
                                  ...
                                  , ensuring accurate assessment. Additionally,
                                  the day count will be determined by the{" "}
                                  <Text style={styles.textBold}>
                                    current date
                                  </Text>
                                  .
